...
export default function RefundCancellationPage() {
  return (
    <LegalDocument title="Refund & Cancellation Policy" lastUpdated="25 September 2026">
      <p>
        The full price of a session, including any platform fee, is always shown before you confirm
        a booking. These are the default windows and percentages (docs/17); an admin may publish a
        different rule for a specific service or promotion, always disclosed at booking.
      </p>
      ...
      <ul>
        ...
        <li>
          Less than 6 hours before start: no refund, except one courtesy late cancellation per
          rolling 90 days, refunded at the 50% rate.
        </li>
      </ul>
      ...
      <p>
        ...
        example, a payment captured after the slot was already lost to someone else), the payment is
        refunded in full.
      </p>
