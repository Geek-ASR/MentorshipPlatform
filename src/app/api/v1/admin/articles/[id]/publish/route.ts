...
import { publishArticle } from "@/server/modules/content";
...
export const POST = defineRoute(
  {
    name: "POST /api/v1/admin/articles/:id/publish",
    params: paramsSchema,
    body: bodySchema,
  ...
  async ({ actor, params, body, getDb, clock }) => {
    ...
    const article = await publishArticle(await getDb(), actor.userId, params.id, {
